# -*- coding: utf-8 -*-
"""Assig 1_Intelli_Doc_Newgen.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1LH1JQJ69qgXfUz0NqANj6Z7-yi1BYoan
"""
...
# ==========================================
# 1. UI Wrapper Functions
# ==========================================
def ui_process_pdf(file_obj):
    if file_obj is None:
        return "⚠️ Please upload a PDF file first."
    try:
        # file_obj.name contains the temporary file path in Colab
...
def ui_chat(query, history):
    ...
    if not global_full_text:
        # Professional error state formatting
...
/* Standalone Dispatcher Activity Box Styling */
.tool-status input {
...
/* Dynamic Tool Badges embedded in Chat */
.tool-badge {
...
# A clean, high-contrast theme focused on blue and slate
...
with gr.Blocks(theme=professional_theme, css=custom_css) as demo:
    ...
    with gr.Row():
        ...
        with gr.Column(scale=3):
            # RESTORED: The standalone Agent Dispatcher Activity box, styled via CSS
            ...
            chatbot = gr.Chatbot(
                ...
                height=500,
                type="messages",
                avatar_images=("👤", "🧠"), # Professional avatars
